...
Validates total number of records in the dataset after loading.

![Row Count](SQL_Row_Count.png)
...
These SQL results were used to:
- Validate data integrity
- Perform aggregations
- Cross-check findings with Excel, Python, and Tableau outputs
